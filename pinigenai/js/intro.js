...
function loadSubtitles(){
    ...
    $.ajax({
        type: 'POST',
        url: 'gameadmin/getcontent.php?lan='+videoLanguage+'&game=intro',
...
function resizeEvent(){
    ...
    */
    ...
    if(videoScale < 1){
        ...
        TweenMax.set("#showVideoSubtitles", {top:"0",left:"0",width:"100%",height:"25%"});
        TweenMax.set("#skipintrobtn", {top:"25%",left:"50%",width:"50%",height:"75%"});
        TweenMax.set("#mutebtn", {top:"25%",left:"0",width:"50%",height:"75%"});
        ...
        TweenMax.set("#showVideoSubtitles", {top:"-70px",left:(230+offset)+"px",width:"auto",height:"auto"});
        TweenMax.set("#skipintrobtn", {top:607+"px",left:(640+offset)+"px",width:"auto",height:"auto"});
        TweenMax.set("#mutebtn", {top:655+"px",left:(200+offset)+"px",width:"auto",height:"auto"});
    }
...
function showVideoSubtitles(){
	if(videoSubtitlesOn){
		...
		TweenMax.to($("#videoSubtitles"), 0.3, {y:0});
	}else{
		videoSubtitlesOn = true;
		TweenMax.to($("#videoSubtitles"), 0.3, {y:160});
	}
}
