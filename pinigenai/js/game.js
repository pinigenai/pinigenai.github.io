...
function gameResizeEvent(){
    ...
    if(isMobile || isIPad){
        if(window.innerHeight > window.innerWidth){
            ...
            TweenMax.set("#nameinput", {scale: mobileScale, transformOrigin:"0% 0%"} );
            $("#nameinput").css("top",Math.floor(211*mobileScale)+"px");
            $("#nameinput").css("left","calc(50% + "+Math.floor(112*mobileScale)+"px)");

            TweenMax.set("#monoinput", {scale: mobileScale, transformOrigin:"0% 0%"} );
            ...
            TweenMax.set(".mononameinput", {scale: mobileScale, transformOrigin:"0% 0%"} );
...
function setupPixi(){
    ...
    if(navigator.userAgent.indexOf('MSIE')!==-1 || navigator.appVersion.indexOf('Trident/') > -1){
        ...
        app = new PIXI.Application({width: window.innerWidth, height: window.innerHeight, autoDensity: true, resolution: window.devicePixelRatio, forceCanvas: true});
    }else{
        app = new PIXI.Application({width: window.innerWidth, height: window.innerHeight, autoDensity: true, resolution: window.devicePixelRatio });
    }
...
function showPreloader(){
    if(preloadPopup){
        ...
        if(isMobile || isIPad){
            ...
            TweenMax.to(preloadPopup, 0.2, { alpha: 1 });
        }
...
function preloadProgress(loader,res) {
    ...
    if(Math.round(loader.progress) >= 100){
        if(isMobile || isIPad){
            ...
            TweenMax.to(preloadPopup, 0.2, { delay: 0.65, alpha: 0, onComplete: doRemovePreloader });
        }    
    }
}
...
function setupInterface(){
    if(topBar){
        ...
        frontGround.subtitlesLabel = new PIXI.Text("", new PIXI.TextStyle({fontFamily: "Arial",fontSize: 12,fill: "white",fontWeight: "normal",wordWrap:true,wordWrapWidth:500}));
        ...
        frontGround.subtitlesBtnLabel = new PIXI.Text(universeData.pengeby_subtitlesButtonOff.content, new PIXI.TextStyle({fontFamily: "Arial",fontSize: 12,fill: "white",fontWeight: "normal",wordWrap:true,wordWrapWidth:500}));
...
function toggleSubtitles(){
    if(frontGround.showSubtitles){
        ...
        TweenMax.to(frontGround.subtitles, 0.35, {pixi:{y:-140}, ease:Power2.easeIn});
    }else{
        frontGround.showSubtitles = true;
        frontGround.subtitlesBtnLabel.text = universeData.pengeby_subtitlesButtonOn.content;

        TweenMax.to(frontGround.subtitles, 0.35, {pixi:{y:0}, ease:Power2.easeIn});
...
function showWishlist(){
    ...
    for (var i = 0; i < user.wishlist.length; i++) {
        ...
        var goldTF = new PIXI.Text(gold, new PIXI.TextStyle({fontFamily: "Arial",fontSize: 18,fill: "white",fontWeight: "bold"}));
        goldTF.x=68;
        goldTF.y=190;
        wishlistItem.addChild(goldTF);
        goldTF.interactive=false;

        var silverTF = new PIXI.Text(silver, new PIXI.TextStyle({fontFamily: "Arial",fontSize: 18,fill: "white",fontWeight: "bold"}));
        silverTF.x=110;
        silverTF.y=190;
...
function initUniverse(){
    ...
    frontGround.goldTF = new PIXI.Text(gold, new PIXI.TextStyle({fontFamily: "Arial",fontSize: 35,fill: "white",fontWeight: "bold"}));
    ...
    frontGround.silverTF = new PIXI.Text(silver, new PIXI.TextStyle({fontFamily: "Arial",fontSize: 35,fill: "white",fontWeight: "bold"}));
...
function resetCloud(cloud){
    cloud.x=1100;
    TweenMax.to(cloud, 25, { pixi:{ x:-100 }, ease:Power0.easeNone, onComplete:resetCloud, onCompleteParams:[cloud]  });
}
...
function drawUniverse(){
    if(universeContainer){
        ...
        if(user.gateDone){
            ...
            //pulse
            TweenMax.set(universeContainer.cityGate, { pixi:{scale:1.1}});
            TweenMax.to(universeContainer.cityGate, 0.5, { pixi:{scale:1}, ease:Power2.easeIn, yoyo:true, repeat:-1 });
        }
        ...
        if(isMobile){
            ...
            for (var i = 0; i < universeContainer.children.length; i++) {
                if(universeContainer.children[i].type == "cloud"){
                    ...
                    TweenMax.to(cloud, 25, { pixi:{ x:cloud.x-1200 }, ease:Power0.easeNone, onComplete:resetCloud, onCompleteParams:[cloud],onUpdate:checkCloud, onUpdateParams:[cloud]  });
                }
            }
        }
        ...
        if(user.gateDone){
            ...
            TweenMax.set(portGame, { pixi:{scale:1.1}});
            TweenMax.to(portGame, 0.5, { pixi:{scale:1}, ease:Power2.easeIn, yoyo:true, repeat:-1 });
        }
...
function appleGameHover(){
    ...
    TweenMax.to(this.children[0], 0.35, { pixi:{scaleX:1.5, scaleY:1.5, x:-10, y:40 }});
    TweenMax.to(this.children[1], 0.35, { pixi:{scaleX:1.5, scaleY:1.5, x:90, y:-15 }});
...
function appleGameEndHover(){
    ...
    TweenMax.to(this.children[0], 0.35, {delay:0.2, pixi:{scaleX:1, scaleY:1, x:8, y:59 }});
    TweenMax.to(this.children[1], 0.35, {delay:0.2, pixi:{scaleX:1, scaleY:1, x:84, y:15 }});
...
function postOfficeHover(){
    ...
    TweenMax.to(this.children[0], 0.35, { pixi:{scaleX:1.5, scaleY:1.5, x:50, y:22 }});
...
function postOfficeEndHover(){
    ...
    TweenMax.to(this.children[0], 0.35, {delay:0.2, pixi:{scaleX:1, scaleY:1, x:65, y:55 }});
...
function portHover(){
    ...
    TweenMax.to(this, 0.35, {pixi:{scale:1.2}, ease:Power2.easeIn});
}

function portEndHover(){
    TweenMax.set(this, { pixi:{scale:1.1}});
    TweenMax.to(this, 0.5, { pixi:{scale:1}, ease:Power2.easeIn, yoyo:true, repeat:-1 });
}
...
function backToUniverse(){
    ...
    TweenMax.to(bottomBar, 0.3, {pixi:{y:550}});
...
function showRoom(){
    ...
    if(localTest){
        loadRoomResources({"speak_b_room_welcome":{"contenttype":"sound","content":"dk_velkommen_til_vaerelse.mp3","subtitle":"Velkommen til dit v\u00e6relse. Hvis du har lyst til at skifte t\u00f8j, skal du bare klikke p\u00e5 skabet. Husk, at du kan k\u00f8be mere t\u00f8j og flere ting til dit v\u00e6relse i Karens Butik. Hvis du har v\u00e6ret ude at rejse med Tidsmaskinen, kan du ovre p\u00e5 hylden se de ting, du har f\u00e5et. Og hvis Troldmanden har fortalt dig sin hemmelighed, h\u00e6nger dit diplom p\u00e5 tavlen. Klik p\u00e5 kortet for at g\u00e5 p\u00e5 opdagelse i Pengeby! "}});
    }else{
        $.ajax({
            type: 'GET',
...
function nextClosetShoes(){
    for (var i = 0; i < gameConfig.closetShoeArray.length; i++) {
        TweenMax.to(gameConfig.closetShoeArray[i], 0.35, {pixi:{ x: gameConfig.closetShoeArray[i].x-150 }, ease:Power2.easeInOut, onComplete:checkClosetItemVisible, onCompleteParams:[gameConfig.closetShoeArray[i]]});
...
function nextClosetClothes(){
    for (var i = 0; i < gameConfig.closetClothesArray.length; i++) {
        TweenMax.to(gameConfig.closetClothesArray[i], 0.35, {pixi:{ x: gameConfig.closetClothesArray[i].x-150 }, ease:Power2.easeInOut, onComplete:checkClosetItemVisible, onCompleteParams:[gameConfig.closetClothesArray[i]]});
    }
...
function showKarens(){
    ...
    if(localTest){
        loadKarensResources({"speak_b_karens_welcome":{"contenttype":"sound","content":"dk_velkomst_og_forklaring_karens_butik.mp3","subtitle":"Nu er du p\u00e5 vej ind i Karens butik. Her kan du k\u00f8be en masse t\u00f8j og ting til dit v\u00e6relse for dine penge. Klik p\u00e5 de ting, du gerne vil k\u00f8be! Hvis du ikke har penge nok til dem, kan du altid komme dem i din \u00f8nskekrukke, s\u00e5 du kan spare op til dem. Tryk p\u00e5 den gr\u00f8nne knap for at komme ind i butikken."},"speak_karens_bought1":{"contenttype":"sound","content":"dk_vare_koebt_1.mp3","subtitle":"Nu har du k\u00f8bt den!"},"speak_karens_bought2":{"contenttype":"sound","content":"dk_vare_koebt_2.mp3","subtitle":"S\u00e5dan, nu er den din!"},"speak_karens_buy1":{"contenttype":"sound","content":"dk_koeb_vare.mp3","subtitle":"Den er fin! Hvor mange penge har du tilbage, hvis du k\u00f8ber den?"},"speak_karens_buy2":{"contenttype":"sound","content":"dk_koeb_vare_2.mp3","subtitle":"Den ser flot ud. Har du penge til den?"},"speak_karens_buy3":{"contenttype":"sound","content":"dk_koeb_vare_3.mp3","subtitle":"Hvis du k\u00f8ber den, hvor mange penge har du s\u00e5?"},"speak_karens_done":{"contenttype":"sound","content":"dk_afslutning_karen.mp3","subtitle":"Farvel, og tak for denne gang! Kom snart igen."},"speak_karens_intro":{"contenttype":"sound","content":"dk_intro.mp3","subtitle":"Er der nogle ting, du godt kunne t\u00e6nke dig i min butik?"},"speak_karens_wishlist":{"contenttype":"sound","content":"dk_ikke_raad_til_vare.mp3","subtitle":"Den har du desv\u00e6rre ikke penge nok til at k\u00f8be! Men du kan komme den i \u00f8nskekrukken, hvis du gerne vil spare op til den. Hvor mange penge mangler du?"},"karens_door_opens_with_bell":{"contenttype":"sound","content":"karens_door_opens_with_bell.mp3","subtitle":""},"karens_ok":{"contenttype":"sound","content":"karens_ok_lyd_3.mp3","subtitle":""},"karens_pay":{"contenttype":"sound","content":"karens_betale_penge_.mp3","subtitle":""},"item_car":{"contenttype":"sound","content":"Bil.mp3","subtitle":""},"item_cd":{"contenttype":"sound","content":"CD.mp3","subtitle":""},"item_elephant":{"contenttype":"sound","content":"Elefant.mp3","subtitle":""},"item_guitar":{"contenttype":"sound","content":"Guitar.mp3","subtitle":""},"item_house":{"contenttype":"sound","content":"Dukkehus.mp3","subtitle":""},"item_keyboard":{"contenttype":"sound","content":"Keyboard_1.mp3","subtitle":""},"item_magicwand":{"contenttype":"sound","content":"Tryllestav_0.mp3","subtitle":""},"item_mobile":{"contenttype":"sound","content":"Mobiltelefon_2.mp3","subtitle":""},"item_plain":{"contenttype":"sound","content":"Flyvemaskine.mp3","subtitle":""},"item_radio":{"contenttype":"sound","content":"radio.mp3","subtitle":""},"item_rocket":{"contenttype":"sound","content":"Raket.mp3","subtitle":""}});
    }else{
        $.ajax({
            type: 'GET',
...
function showTimeMachine(){
    ...
    if(localTest){
        loadTMReseources({"speak_b_timemachine_welcome":{"contenttype":"sound","content":"dk_velkomst_og_forklaring_tidsmaskine.mp3","subtitle":"Velkommen til Tidsmaskinen. Her kan du rejse tilbage i tiden og pr\u00f8ve en masse sjove og sp\u00e6ndende ting - men kun, hvis du har penge nok. Det koster nemlig en guldm\u00f8nt, hver gang du rejser. Klik p\u00e5 den gr\u00f8nne knap for at v\u00e6lge, hvor du gerne vil rejse hen."},"speak_timemachine_nocash":{"contenttype":"sound","content":"dk_ikke_raad.mp3","subtitle":"Det har du desv\u00e6rre ikke r\u00e5d til, s\u00e5 du m\u00e5 ud og tjene nogle penge!"},"speak_timemachine_travel":{"contenttype":"sound","content":"dk_god_tur.mp3","subtitle":""},"speak_timemachine_rome":{"contenttype":"sound","content":"dk_forklaring_paa_rom.mp3","subtitle":"Det her er rejsen til det gamle Rom. Her kan du hj\u00e6lpe med at bygge flotte og store bygninger."},"speak_timemachine_dino":{"contenttype":"sound","content":"dk_forklaring_paa_dinosaur.mp3","subtitle":"Her kan du rejse tilbage til dengang, hvor der fandtes dinosaurusser og hj\u00e6lpe med at finde dinosaurus \u00e6g."},"speak_timemachine_ridder":{"contenttype":"sound","content":"dk_forklaringp_paa_riddertiden.mp3","subtitle":"Her kan du rejse tilbage til Riddertiden og pr\u00f8ve at k\u00e6mpe som en ridder."},"speak_timemachine_egypt":{"contenttype":"sound","content":"dk_forklaring_paa_aegypten.mp3","subtitle":"Det her er rejsen til det gamle Egypten. Her er de i gang med at bygge verdens st\u00f8rste pyramide, og du kan hj\u00e6lpe med at indrette den."},"timemachine_ambient_sound1":{"contenttype":"sound","content":"timemachine_tidsmaskine_blib_blob_lyd_1.mp3","subtitle":""},"timemachine_ambient_sound2":{"contenttype":"sound","content":"timemachine_tidsmaskine_blib_blob_lyd_8.mp3","subtitle":""}});
    }else{
        $.ajax({
            type: 'GET',
...
function showDinoGame(){
    ...
    if(localTest){
        loadDinoReseources({"speak_b_dino_loose1":{"contenttype":"sound","content":"dk_spil_slut_tapt_1.mp3","subtitle":"Ej, du n\u00e5ede at miste alle dine liv, f\u00f8r du fik fat i \u00e6ggene. Pr\u00f8v igen."},"speak_b_dino_loose2":{"contenttype":"sound","content":"dk_spil_slut_tapt_2.mp3","subtitle":"Det var \u00e6rgerligt - du har ikke flere fors\u00f8g til at finde \u00e6ggene. M\u00e5ske skal du passe lidt bedre p\u00e5 n\u00e6ste gang? Pr\u00f8v igen for at se, om du kan g\u00f8re det bedre!"},"speak_b_dino_welcome":{"contenttype":"sound","content":"dk_velkomst_og_forklaring_dinosaurus.mp3","subtitle":"Nu har du rejst meget langt tilbage i tiden, nemlig til dengang, hvor der fandtes dinosaurusser. Dinosarus mor er blevet ked af det, fordi hun har mistet sine \u00e6g, og du skal derfor hj\u00e6lpe med at finde dem. For at finde \u00e6ggene skal du bruge pilene p\u00e5 tastaturet og grave dig ned igennem jorden. Du skal samle alle hjerterne, f\u00f8r du kan f\u00e5 fat i et \u00e6g. Men pas p\u00e5 de farlige ting undervejs - og skynd dig alt, hvad du kan! Tryk p\u00e5 den gr\u00f8nne knap, n\u00e5r du er klar."},"speak_b_dino_won1":{"contenttype":"sound","content":"dk_spil_slut_gennemfoert_1.mp3","subtitle":"Du fandt alle \u00e6ggene - godt g\u00e5et! Pr\u00f8v at se, om du kan g\u00f8re det endnu hurtigere!"},"speak_b_dino_won2":{"contenttype":"sound","content":"dk_spil_slut_gennemfoert_2.mp3","subtitle":"Det er du god til - du fandt alle \u00e6ggene! Tror du, at du kan g\u00f8re det endnu hurtigere?"},"dino_ambient":{"contenttype":"sound","content":"dino_dinosaur_regnskovs_ambient_mix.mp3","subtitle":""},"dino_complete":{"contenttype":"sound","content":"dino_complete.mp3","subtitle":""},"dino_digging":{"contenttype":"sound","content":"dino_grave_under_jorden-lyd.mp3","subtitle":""},"dino_hart":{"contenttype":"sound","content":"dino_hjerte_plingeling.mp3","subtitle":""},"dino_monster":{"contenttype":"sound","content":"dino_monster_snapper_flere_gange.mp3","subtitle":""},"dino_remove_rock":{"contenttype":"sound","content":"dino_opmaerksom-lyd_egg_kan_hentes.mp3","subtitle":""},"dino_stone_in_the_head":{"contenttype":"sound","content":"dino_ser_stjerner_efter_sten_i_hovedet.mp3","subtitle":""}});
    }else{
        $.ajax({
            type: 'GET',
...
function showEgyptGame(){
    ...
    if(localTest){
        loadEgyptReseources({"speak_b_egypt_welcome":{"contenttype":"sound","content":"dk_velkomst_og_forklaring_aegypten.mp3","subtitle":"Nu er du tilbage i det gamle Egypten, hvor de er i gang med at bygge verdens st\u00f8rste pyramide, som hedder Keops pyramiden. Du skal hj\u00e6lpe med at g\u00f8re det store rum til faraoen, som er en slags konge, rigtig flot! Du kan male v\u00e6ggen og dekorere den med flotte ting. Tryk p\u00e5 den gr\u00f8nne knap, n\u00e5r du er klar!"},"egypt_ambient":{"contenttype":"sound","content":"egypt_ambient.mp3","subtitle":""},"egypt_urne_open":{"contenttype":"sound","content":"egypt_mus_over_urner_hiroglyffer_ud_af_krukke.mp3","subtitle":""}});
    }else{
        $.ajax({
            type: 'GET',
...
function startEgyptGame(){
    ...
    btn.on("pointerover", function(){this.gotoAndStop(1)});
    btn.on("pointerout", function(){this.gotoAndStop(0)});
    ...
    btn.name = "2";
    gameContainer.addChild(btn);
    btn.on("pointerover", function(){this.gotoAndStop(3)});
    btn.on("pointerout", function(){this.gotoAndStop(2)});
    makeButton(btn, openJar);
    cleanUpArray.push(btn);
    ...
    btn.name = "3";
    gameContainer.addChild(btn);
    btn.on("pointerover", function(){this.gotoAndStop(5)});
    btn.on("pointerout", function(){this.gotoAndStop(4)});
    makeButton(btn, openJar);
    cleanUpArray.push(btn);
...
function showRomeGame(){
    ...
    if(localTest){
        loadRomeReseources({"speak_b_rome_complete":{"contenttype":"sound","content":"dk_afslutning.mp3","subtitle":"Det var du god til! Synes du ikke, at den er blevet flot? Det synes jeg, den er."},"speak_b_rome_startPuzzle":{"contenttype":"sound","content":"dk_velkomst_og_forklaring_rom_0.mp3","subtitle":"Du skal tr\u00e6kke brikkerne med musen over p\u00e5 det rigtige sted p\u00e5 tegningen. N\u00e5r du har sat alle brikkerne rigtig, er du f\u00e6rdig. Tryk p\u00e5 den gr\u00f8nne knap, n\u00e5r du er klar til at bygge."},"speak_b_rome_welcome":{"contenttype":"sound","content":"dk_velkomst_og_forklaring_rom.mp3","subtitle":"Velkommen tilbage til det gamle Rom. Her skal du hj\u00e6lpe med at bygge flotte bygninger! Du kan v\u00e6lge imellem tre forskellige bygninger - den f\u00f8rste er den nemmeste, og den sidste er den sv\u00e6reste."},"rome_ambient":{"contenttype":"sound","content":"rome_folkemasse_ambient_1.mp3","subtitle":""},"rome_ambient_start":{"contenttype":"sound","content":"rome_ambient_opstart.mp3","subtitle":""},"rome_brick":{"contenttype":"sound","content":"rome_brick.mp3","subtitle":""},"rome_complete":{"contenttype":"sound","content":"rome_complete.mp3","subtitle":""}});
    }else{
        $.ajax({
            type: 'GET',
...
function initRome(loader, resources){
    ...
    gameConfig.btn1.on("pointerover", function(){this.gotoAndStop(1)});
    gameConfig.btn1.on("pointerout", function(){this.gotoAndStop(0)});
    ...
    gameConfig.btn2.on("pointerover", function(){this.gotoAndStop(1)});
    gameConfig.btn2.on("pointerout", function(){this.gotoAndStop(0)});
    ...
    gameConfig.btn3.on("pointerover", function(){this.gotoAndStop(1)});
    gameConfig.btn3.on("pointerout", function(){this.gotoAndStop(0)});
...
function showKnightGame(){
    ...
    if(localTest){
        loadRidderReseources({"speak_b_ridder_complete":{"contenttype":"sound","content":"game_over_1.mp3","subtitle":"Det er du god til! Pr\u00f8v igen for at se, om du kan g\u00f8re det bedre."},"speak_b_ridder_welcome":{"contenttype":"sound","content":"velkommen_ridder_se.mp3","subtitle":"Nu har du rejst tilbage til middelalderen, og her skal du bruge en armbr\u00f8st for at skyde pile efter en m\u00e5lskive. Du skal trykke p\u00e5 de brune pile p\u00e5 armbr\u00f8sten for at bestemme, hvilken retning du vil skyde. Og du skal ogs\u00e5 indstille hvor h\u00e5rdt. N\u00e5r du tror, at du vil skyde h\u00e5rdt nok og i den rigtige retning til at ramme m\u00e5lskiven, skal du trykke p\u00e5 den gr\u00f8nne knap for at skyde. Pr\u00f8v og se, hvor mange point du kan f\u00e5! Tryk p\u00e5 den gr\u00f8nne knap for at g\u00e5 i gang!"},"ridder_hit":{"contenttype":"sound","content":"Bue_rammer.mp3","subtitle":""},"ridder_miss":{"contenttype":"sound","content":"Bue_misser.mp3","subtitle":""},"ridder_shoot":{"contenttype":"sound","content":"bue_bliver_skudt.mp3","subtitle":""}});
    }else{
        $.ajax({
            type: 'GET',
...
function showAppleGame(){
    ...
    if(localTest){
        loadAppleResources({"speak_b_apple_done":{"contenttype":"sound","content":"dk_afslutning_game_over.mp3","subtitle":"Sikke en masse god juice du fik lavet! Men du tabte tre \u00e6bler p\u00e5 jorden. Du kan pr\u00f8ve igen, hvis du gerne vil tjene flere penge! Har du penge nok, kan du rejse en tur med Tidsmaskinen. Det kan ogs\u00e5 v\u00e6re, at der er kommet nogle flere ting i Karens butik, du kunne t\u00e6nke dig?"},"speak_b_apple_done_no_money":{"contenttype":"sound","content":"dk_afslutning_game_over_no_apples.mp3","subtitle":"Du tabte tre \u00e6bler p\u00e5 jorden. Du kan pr\u00f8ve igen, hvis du gerne vil tjene flere penge! Har du penge nok, kan du rejse en tur med Tidsmaskinen. Det kan ogs\u00e5 v\u00e6re, at der er kommet nogle flere ting i Karens butik, du kunne t\u00e6nke dig?"},"speak_b_apple_nextlevel_1":{"contenttype":"sound","content":"dk_naeste_niveau_1.mp3","subtitle":"Det var du god til! Nu g\u00e5r det lidt hurtigere."},"speak_b_apple_nextlevel_2":{"contenttype":"sound","content":"dk_naeste_niveau_2.mp3","subtitle":"Godt g\u00e5et! Nu g\u00e5r det endnu hurtigere."},"speak_b_apple_nextlevel_3":{"contenttype":"sound","content":"dk_naeste_niveau_3.mp3","subtitle":"Det var flot! Nu bliver det lidt sv\u00e6rere."},"speak_b_apple_nextlevel_4":{"contenttype":"sound","content":"dk_naeste_niveau_4.mp3","subtitle":"Hvor er du skrap! Kan du ogs\u00e5 klare n\u00e6ste omgang?"},"speak_b_apple_welcome":{"contenttype":"sound","content":"dk_velkomst_og_forklaring_aeblebod.mp3","subtitle":"Velkommen til din \u00e6blebod. Her kan du tjene penge ved at lave \u00e6blejuice til folkene i Pengeby. Du skal fange \u00e6blerne, der falder ned fra det store \u00e6bletr\u00e6, inden de rammer jorden. Du m\u00e5 ikke tabe mere end tre \u00e6bler p\u00e5 jorden. Du skal bruge piletasterne p\u00e5 computeren for at l\u00f8be frem og tilbage. Hver gang du har samlet 10 \u00e6bler, tjener du penge. Er du klar til at se, hvor mange \u00e6bler du kan samle? S\u00e5 tryk p\u00e5 den gr\u00f8nne knap."},"apple_apple_caught":{"contenttype":"sound","content":"apple_apple_fanges_i_kurven.mp3","subtitle":""},"apple_apple_dropped":{"contenttype":"sound","content":"apple_apple_falder_til_jorden_.mp3","subtitle":""},"apple_juice_sound":{"contenttype":"sound","content":"apple_juice_maskine.mp3","subtitle":""},"apple_step_left":{"contenttype":"sound","content":"apple_skridt_til_venstre.mp3","subtitle":""}});
    }else{
        $.ajax({
            type: 'GET',
...
function startAppleGame(){
    ...
    for (var i = 0; i < gameConfig.apples.length; i++) {
        ...
        if(i == gameConfig.apples.length-1){
            TweenMax.to(gameConfig.apples[i], 0.25, {alpha:1, delay:i*0.3, onComplete:startAppleFall});
        }else{
            TweenMax.to(gameConfig.apples[i], 0.25, {alpha:1, delay:i*0.3});
        }        
    }    
}
...
function startAppleFall(){
    ...
    TweenMax.delayedCall(gameConfig.shakeSpan, function(){appleShakeTween.kill()});
    TweenMax.to(randomApple, gameConfig.fallSpeed, {delay:gameConfig.shakeSpan, pixi:{ y:470+Math.floor(Math.random()*40) }, onComplete:endAppleFall, onCompleteParams:[randomApple], onUpdate:checkBasket, onUpdateParams:[randomApple], ease:Power2.easeIn});
}
...
function appleShake(apple){    
    appleShakeTween = TweenMax.to(apple, 0.05, {
          pixi:{x: randomNum(applePos[0]-3, applePos[0]+3),
...
function showPostOfficeGame(){
    ...
    if(localTest){
        loadPostResources({"speak_b_postoffice_welcome":{"contenttype":"sound","content":"dk_velkomst_og_forklaring_postkontoret.mp3","subtitle":"Velkommen til postkontoret. Her skal du hj\u00e6lpe Postmesteren med at sortere pakkerne, der skal leveres i Pengeby! De dyreste pakker skal ud f\u00f8rst, og de billigste pakker skal ud til sidst. Du skal bruge musen og tr\u00e6kke de rigtige pakker op i de rigtige bakker; de dyreste skal st\u00e5 til venstre og de billigste skal st\u00e5 til h\u00f8jre. N\u00e5r du er klar, s\u00e5 tryk p\u00e5 den gr\u00f8nne knap!"},"speak_postoffice_correct_1":{"contenttype":"sound","content":"pengeby_det_er_du_god_til.mp3","subtitle":"Det er du god til!"},"speak_postoffice_correct_2":{"contenttype":"sound","content":"pengeby_godt_gaaet.mp3","subtitle":"Godt g\u00e5et!"},"speak_postoffice_correct_3":{"contenttype":"sound","content":"pengeby_nu_bliver_det_lidt.mp3","subtitle":"Nu bliver det lidt sv\u00e6rere. Er du klar?"},"speak_postoffice_correct_4":{"contenttype":"sound","content":"dk_rigtig_loesning_naeste_bane_2.mp3","subtitle":"Det er du god til! Nu bliver det lidt sv\u00e6rere."},"speak_postoffice_done":{"contenttype":"sound","content":"dk_afslutning_og_resultat.mp3","subtitle":"Tusind tak for hj\u00e6lpen - det var du god til! Som tak for hj\u00e6lpen f\u00e5r du her nogle penge, som du kan bruge i Karens butik eller Tidsmaskinen. Du kan ogs\u00e5 hj\u00e6lpe mig igen, hvis du har lyst?"},"postoffice_error":{"contenttype":"sound","content":"postoffice_fejl_lyd_3.mp3","subtitle":""},"postoffice_left_belt":{"contenttype":"sound","content":"postoffice_transportbaand_left.mp3","subtitle":""},"postoffice_ok":{"contenttype":"sound","content":"postoffice_ok_lyd_2.mp3","subtitle":""},"postoffice_right_belt":{"contenttype":"sound","content":"postoffice_transportbaand_right.mp3","subtitle":""},"postoffice_truck_loads":{"contenttype":"sound","content":"postoffice_lastbil_faar_pakker.mp3","subtitle":""},"postoffice_truck_takes_off":{"contenttype":"sound","content":"postoffice_lastbil_koerer_med_pakkerne.mp3","subtitle":""}})
    }else{
        $.ajax({
            type: 'GET',
...
function placePackages(){    
    ...
    for (var i = 0; i < gameConfig.rulleHjulArrayForward.length; i++) {
        TweenMax.to(gameConfig.rulleHjulArrayForward[i], 1.2, { pixi:{ rotation:"-=360" }, ease:Power0.easeNone });
    }

    playSound("postoffice_left_belt", gameLoader);

    for (var i = 0; i < gameConfig.rulleHjulArrayBack.length; i++) {
        TweenMax.to(gameConfig.rulleHjulArrayBack[i], 1.2, { pixi:{ rotation:"+=360" }, ease:Power0.easeNone });
    }
    ...
    if(postGameLevel >= 5){
        ...
        TweenMax.from(package1, 1.2, { pixi: {x:1140}, ease:Power0.easeNone });
        TweenMax.from(package2, 1.2, { pixi: {x:1255}, ease:Power0.easeNone });
        TweenMax.from(package3, 1.2, { pixi: {x:1370}, ease:Power0.easeNone });

        TweenMax.from(postGameTray1, 1.2, { pixi: {x:-930}, ease:Power0.easeNone });
        TweenMax.from(postGameTray2, 1.2, { pixi: {x:-790}, ease:Power0.easeNone });
        TweenMax.from(postGameTray3, 1.2, { pixi: {x:-650}, ease:Power0.easeNone });
        

    }else{
        TweenMax.from(package1, 1.2, { pixi: {x:1155}, ease:Power0.easeNone });
        TweenMax.from(package2, 1.2, { pixi: {x:1295}, ease:Power0.easeNone });
        TweenMax.from(postGameTray1, 1.2, { pixi: {x:-810}, ease:Power0.easeNone });
        TweenMax.from(postGameTray2, 1.2, { pixi: {x:-660}, ease:Power0.easeNone });
    }
...
function checkPostGameScore(){
    if(postGameLevel < 5){
        if(postGameTray1.children[1].currentFrame != 0 && postGameTray2.children[1].currentFrame != 7){
            ...
            TweenMax.to(postGameTray1, 1.2, { pixi: {x:-510}, ease:Power0.easeNone });
            TweenMax.to(postGameTray2, 1.2, { pixi: {x:-360}, ease:Power0.easeNone, onComplete: showPostTruck });
        ...
        if((postGameTray1.children[1].currentFrame != 0 && postGameTray2.children[1].currentFrame != 7) && postGameTray3.children[1].currentFrame != 14){
            ...
            TweenMax.to(postGameTray1, 1.2, { pixi: {x:-930}, ease:Power0.easeNone });
            TweenMax.to(postGameTray2, 1.2, { pixi: {x:-790}, ease:Power0.easeNone });
            TweenMax.to(postGameTray3, 1.2, { pixi: {x:-650}, ease:Power0.easeNone, onComplete: showPostTruck });
...
function postAddPackage(){
    ...
    if(postGameLevel >= 9){
        TweenMax.to(gamePopup.children[1], 1.5, {pixi:{x: "-=400"}, delay:0.8, ease:Power2.easeIn, onComplete:postTruckGone});
...
function postTruckGone(){
    ...
    TweenMax.set(hand, {pixi:{scale:0.75}});
    TweenMax.to(hand, 1.5, {pixi:{scale:1}});
...
function showFarmGame(){
    ...
    if(localTest){
        loadFarmResources({"speak_b_farm_feed_amount":{"contenttype":"sound","content":"farm_feed_amount_92.mp3","subtitle":"Er du sikker p\u00e5, at det er det rigtige antal?"},"speak_b_farm_intro":{"contenttype":"sound","content":"farm_intro_59.mp3","subtitle":"Velkommen til Bondeg\u00e5rden. Her skal du hj\u00e6lpe med at samle dyrene s\u00e5 de kan f\u00e5 noget at spise. F\u00f8rst skal du finde dyrene. Tr\u00e6k det rigtig antal dyr ind p\u00e5 midten af den store cirkel. Tryk p\u00e5 den gr\u00f8nne knap for at komme i gang."},"speak_farm_feed_cow":{"contenttype":"sound","content":"farm_feed_cow_78.mp3","subtitle":"Nu er k\u00f8erne samlet og nu skal de have mad. Hver s\u00e6k giver mad til 1 ko. Hvor mange s\u00e6kke skal du bruge? Tryk p\u00e5 den gr\u00f8nne knap n\u00e5r du har trukket det rigtige antal s\u00e6kke ind i cirklen"},"speak_farm_feed_duck":{"contenttype":"sound","content":"farm_feed_ducks_67.mp3","subtitle":"S\u00e5 er det spisetid for \u00e6nderne. Hver s\u00e6k giver mad til 4 \u00e6nder, s\u00e5 hvor mange s\u00e6kke skal du nu bruge? Tryk p\u00e5 den gr\u00f8nne knap n\u00e5r du har trukket det rigtige antal s\u00e6kke ind i cirklen"},"speak_farm_feed_horse":{"contenttype":"sound","content":"farm_feed_horse_80.mp3","subtitle":"Nu skal hestene have mad. Hver s\u00e6k giver mad til 2 heste. Hvor mange s\u00e6kke skal du bruge? Tryk p\u00e5 den gr\u00f8nne knap n\u00e5r du har trukket det rigtige antal s\u00e6kke ind i cirklen"},"speak_farm_feed_missing":{"contenttype":"sound","content":"farm_feed_missing91.mp3","subtitle":"Der mangler nogle s\u00e6kke i cirklen. Hvor mange mangler der?"},"speak_farm_feed_sheep":{"contenttype":"sound","content":"farm_feed_sheep_81.mp3","subtitle":"Nu giver hver s\u00e6k mad til 3 f\u00e5r. Hvor mange s\u00e6kke skal du bruge? Tryk p\u00e5 den gr\u00f8nne knap n\u00e5r du har trukket det rigtige antal s\u00e6kke ind i cirklen"},"speak_farm_feed_toomany":{"contenttype":"sound","content":"farm_feed_toomany90.mp3","subtitle":"Der er vist lidt for mange s\u00e6kke i cirklen. Hvor mange skal du tr\u00e6kke ud?"},"speak_farm_gather_cow":{"contenttype":"sound","content":"farm_gather_cows.mp3","subtitle":"Du skal hj\u00e6lpe mig med at finde 12 k\u00f8er. Tr\u00e6k dem ind i den store cirkel!"},"speak_farm_gather_duck":{"contenttype":"sound","content":"farm_gather_ducks_83.mp3","subtitle":"Du klarer det rigtig godt! S\u00e5 er vi ved at v\u00e6re f\u00e6rdige. Som det sidste skal du finde 12 \u00e6nder. Kan du det?"},"speak_farm_gather_horse":{"contenttype":"sound","content":"farm_gather_horses_79.mp3","subtitle":"Det var du god til. Nu skal du finde 12 heste."},"speak_farm_gather_sheep":{"contenttype":"sound","content":"farm_gather_sheep_81.mp3","subtitle":"S\u00e5 er det f\u00e5rnes tur til at f\u00e5 mad. Kan du finde 12 f\u00e5r?"},"speak_farm_gather_toomany":{"contenttype":"sound","content":"farm_gather_toomany.mp3","subtitle":"Nu er der vist lidt for mange dyr i cirklen. Hvor mange skal du tr\u00e6kke ud?"},"speak_farm_gold":{"contenttype":"sound","content":"farm_gold_85.mp3","subtitle":"Det var du god til. Som tak for hj\u00e6lpen f\u00e5r du her 1 guldm\u00f8nt, som du kan bruge i Karens Butik eller i Tidsmakinen. Har du lyst til at hj\u00e6lpe mig en gang til?"},"speak_farm_intro":{"contenttype":"sound","content":"farm_intro_76.mp3","subtitle":"Velkommen til Bondeg\u00e5rden. Her skal du hj\u00e6lpe med at samle dyrene s\u00e5 de kan f\u00e5 noget at spise. F\u00f8rst skal du finde dyrene. Tr\u00e6k det rigtig antal dyr ind p\u00e5 midten af den store cirkel. Tryk p\u00e5 den gr\u00f8nne knap for at komme i gang."},"speak_farm_motivation_1":{"contenttype":"sound","content":"farm_motivation_88.mp3","subtitle":"Jaja, nu er vi ved at v\u00e6re der"},"speak_farm_motivation_2":{"contenttype":"sound","content":"farm_motivation_86.mp3","subtitle":"Det er du god til!"},"speak_farm_motivation_3":{"contenttype":"sound","content":"farm_motivation_87.mp3","subtitle":"Det g\u00e5r godt - du har snart samlet alle dyrene"},"farm_correct":{"contenttype":"sound","content":"farm_correct.mp3","subtitle":""},"farm_cow1":{"contenttype":"sound","content":"ko.mp3","subtitle":""},"farm_cow2":{"contenttype":"sound","content":"KO_02.mp3","subtitle":""},"farm_cow3":{"contenttype":"sound","content":"KO_03.mp3","subtitle":""},"farm_cow4":{"contenttype":"sound","content":"KO_04.mp3","subtitle":""},"farm_duck1":{"contenttype":"sound","content":"goose.mp3","subtitle":""},"farm_duck2":{"contenttype":"sound","content":"GAAS_01.mp3","subtitle":""},"farm_duck3":{"contenttype":"sound","content":"GAAS_02.mp3","subtitle":""},"farm_duck4":{"contenttype":"sound","content":"GAAS_03.mp3","subtitle":""},"farm_hay":{"contenttype":"sound","content":"HOE_02.mp3","subtitle":""},"farm_hay_feed":{"contenttype":"sound","content":"hay.mp3","subtitle":""},"farm_horse1":{"contenttype":"sound","content":"horse.mp3","subtitle":""},"farm_horse2":{"contenttype":"sound","content":"HEST_02.mp3","subtitle":""},"farm_horse3":{"contenttype":"sound","content":"HEST_03.mp3","subtitle":""},"farm_horse4":{"contenttype":"sound","content":"HEST_04.mp3","subtitle":""},"farm_sheep1":{"contenttype":"sound","content":"sheep.mp3","subtitle":""},"farm_sheep2":{"contenttype":"sound","content":"FAAR_01.mp3","subtitle":""},"farm_sheep3":{"contenttype":"sound","content":"FAAR_02.mp3","subtitle":""},"farm_sheep4":{"contenttype":"sound","content":"FAAR_03.mp3","subtitle":""}});
    }else{
        $.ajax({
            type: 'GET',
...
function loadWizardResources(data){
    ...
    .add("twinkle", "files/Ok%2520lyd%25202.mp3")
...
function blockHover(){
    if(this.blockWidth){
        TweenMax.to(this, 0.35, {pixi:{width:this.blockWidth*1.1, height:this.blockHeight*1.1}, ease:Power2.easeIn});
    }else{
        TweenMax.to(this, 0.35, {pixi:{scale:1}, ease:Power2.easeIn});
    }
...
function blockEndHover(){
    if(this.blockWidth){
        TweenMax.to(this, 0.35, {pixi:{width:this.blockWidth, height:this.blockHeight}, ease:Power2.easeIn});
    }else{
        TweenMax.to(this, 0.35, {pixi:{scale:0.85}, ease:Power2.easeIn});
    }
}
...
function initMonopoly(loader, resources){
    ...
    var label = new PIXI.Text(monoData.monopoly_intro_new_game.content, {fontFamily: "Arial",fontSize: 16,fill: "white",fontWeight: "bold"});
    label.x=680;
    label.y=550;
    gameContainer.addChild(label);
    cleanUpArray.push(label);
    ...
    if($.isEmptyObject(user.mono)){
        ...
        var label = new PIXI.Text(monoData.monopoly_intro_saved_game.content, {fontFamily: "Arial",fontSize: 16,fill: "white",fontWeight: "bold"});
        label.x=820;
        label.y=455;
        gameContainer.addChild(label);
        cleanUpArray.push(label);
...
function monoStartSavedGame(){
    ...
    for (var i = 0; i < adultNamesArray.length; i++) {
        gameConfig.selectedAdults.push({name:adultNamesArray[i]});
    }
    ...
    for (var i = 0; i < childNamesArray.length; i++) {
        gameConfig.selectedChildren.push({name:childNamesArray[i]});
    }
...
function monoSelectFamily(){
    ...
    TweenMax.to(bottomBar, 0.3, {pixi:{y:580}});
...
function redrawExpences(){
    ...
    //pay
    var label = new PIXI.Text(monoData.monopoly_startup_items_label_income.content, {fontFamily: "Arial",fontSize: 16,fill: "black",fontWeight: "bold"});
    label.x=130;
    label.y=87;
    ...
    //total
    var label = new PIXI.Text(monoData.monopoly_startup_items_label_revenue.content, {fontFamily: "Arial",fontSize: 16,fill: "black",fontWeight: "bold"});
    label.x=93;
    label.y=382;
    gameConfig.expenceHolder.addChild(label);
    cleanUpArray.push(label);
...
function createPriceIcon(price, xPos, yPos){
    ...
    var goldTF = new PIXI.Text(gold, {fontFamily: "Arial",fontSize: 16,fill: "black",fontWeight: "bold"});
    goldTF.x=0;
    goldTF.y=1;
    icon.addChild(goldTF);

    var silverTF = new PIXI.Text(silver, {fontFamily: "Arial",fontSize: 16,fill: "black",fontWeight: "bold"});
    silverTF.x=45;
    silverTF.y=1;
...
function exitMono(){
    ...
    var exitLabel = new PIXI.Text(monoData.monopoly_save_game.content, {fontFamily: "Arial",fontSize: 16,fill: "white",fontWeight: "bold"});
    exitLabel.x = 430;
    exitLabel.y = 250;
...
function monoAnswerClick(){
    ...
    if((gameConfig.money + price) < 0){
        ...
        var label = new PIXI.Text(monoData.monopoly_occ_status_eco_neg_balance.content, {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "normal", wordWrap:true, wordWrapWidth:150});
    }else{
        resultBG.gotoAndStop(0);
        gameConfig.points++;
        mayorSpeak("speak_b_monopoly_event_gotMoney0");
        playSound("monopoly_pointSound_smiley");
        label = new PIXI.Text(monoData.monopoly_occ_status_eco_pos_balance.content, {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "normal", wordWrap:true, wordWrapWidth:150});
...
function endMonth(){
    ...
    //insert regnskab
    //titel
    var title = new PIXI.Text(monoData.monopoly_bank_header1.content, {fontFamily: "Arial",fontSize: 16,fill: "black",fontWeight: "normal"});
    title.x=443;
    title.y=182;
    ...
    if(gameConfig.petCare){
        ...
        var label = new PIXI.Text(monoData.monopoly_bank_petdoctor.content, {fontFamily: "Arial",fontSize: 13,fill: "black",fontWeight: "normal", wordWrap: true, wordWrapWidth: 140 });
        label.x=xPos-180;
        label.y=yPos-75;
        gameConfig.eventContainer.addChild(label);
        cleanUpArray.push(label);
    ...
    if(gameConfig.transportCare){
        ...
        var label = new PIXI.Text(monoData.monopoly_bank_mechanic.content, {fontFamily: "Arial",fontSize: 13,fill: "black",fontWeight: "normal", wordWrap: true, wordWrapWidth: 140});
        label.x=xPos-180;
        label.y=yPos+45;
        gameConfig.eventContainer.addChild(label);
        cleanUpArray.push(label);
    ...
    //titel
    var title = new PIXI.Text(monoData.monopoly_bank_header2.content, {fontFamily: "Arial",fontSize: 16,fill: "black",fontWeight: "normal"});
    title.x=xPos+3;
    title.y=yPos;
    gameConfig.eventContainer.addChild(title);
    cleanUpArray.push(title);
    ...
    label = new PIXI.Text(gold, {fontFamily: "Arial",fontSize: 15,fill: "white",fontWeight: "normal"});
    label.x=829;
    label.y=519;
    gameConfig.eventContainer.addChild(label);
    cleanUpArray.push(label);

    label = new PIXI.Text(silver, {fontFamily: "Arial",fontSize: 15,fill: "white",fontWeight: "normal"});
    label.x=857;
    label.y=519;
    gameConfig.eventContainer.addChild(label);
    cleanUpArray.push(label);
...
function showSavings(){
    ...
    var label = new PIXI.Text(monoData.monopoly_bank_savings.content, {fontFamily: "Arial",fontSize: 14,fill: "black",fontWeight: "bold", wordWrap:true, wordWrapWidth:150});
    label.x=625;
    label.y=300;
    gameConfig.eventContainer.addChild(label);
    cleanUpArray.push(label);
    ...
    gameConfig.goldLabel = new PIXI.Text(gold, {fontFamily: "Arial",fontSize: 30,fill: "white",fontWeight: "normal"});
    ...
    gameConfig.silverLabel = new PIXI.Text(silver, {fontFamily: "Arial",fontSize: 30,fill: "white",fontWeight: "normal"});
    ...
    gameConfig.goldSaveLabel = new PIXI.Text(gold, {fontFamily: "Arial",fontSize: 13,fill: "black",fontWeight: "bold"});
    ...
    gameConfig.silverSaveLabel = new PIXI.Text(silver, {fontFamily: "Arial",fontSize: 13,fill: "black",fontWeight: "bold"});
...
function showNewYearsParty(){
    ...
    for (var i = 0; i < 13; i++) {
        ...
        gameConfig.goldSaveLabel = new PIXI.Text(gold, {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "bold"});
        gameConfig.goldSaveLabel.x=16;
        gameConfig.goldSaveLabel.y=4;
        btn.addChild(gameConfig.goldSaveLabel);
        cleanUpArray.push(gameConfig.goldSaveLabel);

        gameConfig.silverSaveLabel = new PIXI.Text(silver, {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "bold"});
...
function showMonoFinalScore(){
    ...
    var pointsTF = new PIXI.Text(gameConfig.points, {fontFamily: "Arial",fontSize: 14,fill: "white",fontWeight: "normal"});
    pointsTF.x=516;
    pointsTF.y=233;
    gameConfig.eventContainer.addChild(pointsTF);
    cleanUpArray.push(pointsTF);

    pointsTF = new PIXI.Text(monoData.monopoly_highscore_small_header.content+" "+gameConfig.points, {fontFamily: "Arial",fontSize: 14,fill: "black",fontWeight: "bold"});
    pointsTF.x=472;
    pointsTF.y=270;
    gameConfig.eventContainer.addChild(pointsTF);
    cleanUpArray.push(pointsTF);

    pointsTF = new PIXI.Text(monoData.monopoly_highscore_play_again.content, {fontFamily: "Arial",fontSize: 14,fill: "white",fontWeight: "bold"});
    pointsTF.x=490;
    pointsTF.y=440;
    gameConfig.eventContainer.addChild(pointsTF);
    cleanUpArray.push(pointsTF);
...
function showHoliday(){
    ...
    //header
    var label = new PIXI.Text(monoData.monopoly_summer_header.content, {fontFamily: "Arial",fontSize: 36,fill: "white",fontWeight: "bold"});
    label.x=285;
    label.y=140;
    gameConfig.eventContainer.addChild(label);
    cleanUpArray.push(label);
    ...
    var label = new PIXI.Text(btnTitle, {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "bold"});
    label.x=0;
    label.y=-13;
    countrySelect.addChild(label);
    cleanUpArray.push(label);

    label = new PIXI.Text("4", {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "bold"});
    label.x=17;
    label.y=5;
    countrySelect.addChild(label);
    cleanUpArray.push(label);

    label = new PIXI.Text("0", {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "bold"});
    label.x=50;
    label.y=5;
    countrySelect.addChild(label);
    cleanUpArray.push(label);
    ...
    label = new PIXI.Text("12", {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "bold"});
    label.x=13;
    label.y=5;
    countrySelect.addChild(label);
    cleanUpArray.push(label);
    ...
    label = new PIXI.Text("16", {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "bold"});
    label.x=13;
    label.y=5;
    countrySelect.addChild(label);
    cleanUpArray.push(label);
    ...
    label = new PIXI.Text("8", {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "bold"});
    label.x=17;
    label.y=5;
    countrySelect.addChild(label);
    cleanUpArray.push(label);
    ...
    label = new PIXI.Text("20", {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "bold"});
    label.x=13;
    label.y=5;
    countrySelect.addChild(label);
    cleanUpArray.push(label);
    ...
    label = new PIXI.Text("24", {fontFamily: "Arial",fontSize: 12,fill: "black",fontWeight: "bold"});
    label.x=13;
    label.y=5;
    countrySelect.addChild(label);
    cleanUpArray.push(label);
...
function showHolidayQuiz(){
    ...
    var label = new PIXI.Text("1", {fontFamily: "Arial",fontSize: 16,fill: "white",fontWeight: "bold"});
    label.x=240;
    label.y=225;
    gameConfig.eventContainer.addChild(label);
    ...
    gameConfig.eventContainer.addChild(qBtn);
    gameConfig.sqProgressArray.push(qBtn);
    label = new PIXI.Text("2", {fontFamily: "Arial",fontSize: 16,fill: "white",fontWeight: "bold"});
    label.x=280;
    label.y=225;
    gameConfig.eventContainer.addChild(label);
    cleanUpArray.push(qBtn);
    ...
    gameConfig.eventContainer.addChild(qBtn);
    gameConfig.sqProgressArray.push(qBtn);
    label = new PIXI.Text("3", {fontFamily: "Arial",fontSize: 16,fill: "white",fontWeight: "bold"});
    label.x=320;
    label.y=225;
    gameConfig.eventContainer.addChild(label);
    cleanUpArray.push(qBtn);
    ...
    gameConfig.eventContainer.addChild(qBtn);
    gameConfig.sqProgressArray.push(qBtn);
    label = new PIXI.Text("4", {fontFamily: "Arial",fontSize: 16,fill: "white",fontWeight: "bold"});
    label.x=360;
    label.y=225;
    gameConfig.eventContainer.addChild(label);
    cleanUpArray.push(qBtn);
    ...
    gameConfig.eventContainer.addChild(qBtn);
    gameConfig.sqProgressArray.push(qBtn);
    label = new PIXI.Text("5", {fontFamily: "Arial",fontSize: 16,fill: "white",fontWeight: "bold"});
    label.x=400;
    label.y=225;
    gameConfig.eventContainer.addChild(label);
    cleanUpArray.push(qBtn);
    ...
    label = new PIXI.Text(this.name, {fontFamily: "Arial",fontSize: 24,fill: "black",fontWeight: "bold"});
    label.x=230;
    label.y=180;
    gameConfig.eventContainer.addChild(label);
    cleanUpArray.push(label);
...
function sqAnswerClick(){
    ...
    gameConfig.sqCorrectLabel = new PIXI.Text(question.correcttext, {fontFamily: "Arial",fontSize: 14,fill: "black",fontWeight: "normal", wordWrap: true, wordWrapWidth: 370});
...
function sqGameOver(){
    ...
    gameConfig.sqCorrectLabel = new PIXI.Text(gameConfig.corrects, {fontFamily: "Arial",fontSize: 20,fill: "black",fontWeight: "bold"});
...
function createMonoRow(labelString,frame,amount,xPos,yPos){
    ...
    var label = new PIXI.Text(labelString, {fontFamily: "Arial",fontSize: 13,fill: "black",fontWeight: "bold"});
    label.x=5;
    label.y=5;
    row.addChild(label);
    cleanUpArray.push(label);
    ...
    label = new PIXI.Text(gold, {fontFamily: "Arial",fontSize: 13,fill: "black",fontWeight: "bold"});
    label.x=375;
    label.y=5;
    row.addChild(label);
    cleanUpArray.push(label);

    label = new PIXI.Text(silver, {fontFamily: "Arial",fontSize: 13,fill: "black",fontWeight: "bold"});
    label.x=405;
    label.y=5;
    row.addChild(label);
    cleanUpArray.push(label);
...
function createSQAnswerBtn(index, answerString){
    ...
    var iconNumber = new PIXI.Text(index+1, {fontFamily: "Arial",fontSize: 18,fill: "white",fontWeight: "bold"});
    iconNumber.x=17;
    iconNumber.y=14;
...
function monoUpdateSidebar(){
    ...
    if(gameConfig.sideBar_pointsTF){
        ...
        gameConfig.sideBar_pointsTF = new PIXI.Text(gameConfig.points, {fontFamily : 'Arial', fontSize: 14, fill : 0xffffff });
    ...
    if(gameConfig.sideBar_savedGoldTF){
        ...
        gameConfig.sideBar_savedGoldTF = new PIXI.Text(gold, {fontFamily : 'Arial', fontSize: 14, fill : 0x000000 });
    ...
    if(gameConfig.sideBar_savedSilverTF){
        ...
        gameConfig.sideBar_savedSilverTF = new PIXI.Text(silver, {fontFamily : 'Arial', fontSize: 14, fill : 0x000000 });
    ...
    if(gameConfig.sideBar_goldTF){
        ...
        gameConfig.sideBar_goldTF = new PIXI.Text(gold, {fontFamily : 'Arial', fontSize: 14, fill : 0xffffff });
    ...
    if(gameConfig.sideBar_silverTF){
        ...
        gameConfig.sideBar_silverTF = new PIXI.Text(silver, {fontFamily : 'Arial', fontSize: 14, fill : 0xffffff });
...
function stopMayorSpeak(){
    if(mayor.isSpeaking){
        ...
        mayor.mouth.gotoAndStop(0);
        TweenMax.to(mayor, 0.35, { pixi: { scale:0.65 }});
        mayor.isSpeaking = false;
    }
}
...
function playMayor(){
    ...
    TweenMax.to(mayor, 0.35, { pixi: { scale:1 }});
}
